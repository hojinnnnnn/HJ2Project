...
void main(void) {
	...
	appendTerm(A, 7, 6);	//다항식 리스트 A에     노드 추가
	appendTerm(A, 5, 3);	//다항식 리스트 A에     노드 추가
	appendTerm(A, 9, 2);	//다항식 리스트 A에     노드 추가
	appendTerm(A, 1, 0);	//다항식 리스트 A에     노드 추가
	printf("\n A(x) =");
	printpoly(A);			//다항식 리스트 A 출력

	appendTerm(B, 5, 3);	//다항식 리스트 B에     노드 추가
	appendTerm(B, 2, 2);	//다항식 리스트 B에     노드 추가
	appendTerm(B, 1, 1);	//다항식 리스트 B에     노드 추가
	appendTerm(B, 10, 0);	//다항식 리스트 B에     노드 추가
	printf("\n B(x) =");
